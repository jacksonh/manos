The Templates/base.html along with the Content/css and Content/js
directories are from the HTML5 Boilerplate project
(http://www.html5boilerplate.com)

The Following is the HTML5 Boilerplate README file:
